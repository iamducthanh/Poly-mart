...
//                change();
	...
	public void change(String oldPassword, String newPassword, String confirmNewPassword) {
		if (EntityValidate.checkOldPasswordChange(oldPassword, this)
				&& EntityValidate.checkNewPasswordChange(newPassword, this)
				&& EntityValidate.checkConfirmNewPasswordChange(confirmNewPassword, this)) {
