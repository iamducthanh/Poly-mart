...
public class ThemHoaDonThanhToanJInternalFrame extends JInternalFrame {
    ...
    private JTable tableThemHoaDonThanhToan;
    DefaultTableModel modelThemHoaDonThanhToan = new DefaultTableModel();
    ...
    public ThemHoaDonThanhToanJInternalFrame() {
        ...
        gl_panel_2.setVerticalGroup(
        	gl_panel_2.createParallelGroup(Alignment.TRAILING)
        		.addGroup(gl_panel_2.createSequentialGroup()
        			.addComponent(cbbKhachHang, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE)
        			...
        			.addPreferredGap(ComponentPlacement.UNRELATED)
        			.addComponent(btnHoanThanh, GroupLayout.PREFERRED_SIZE, 29, GroupLayout.PREFERRED_SIZE)
        			.addGap(7))
        );
        ...
        JLabel lblNewLabel_1_1_1_1_3 = new JLabel("Giảm giá");
        lblNewLabel_1_1_1_1_3.setFont(new Font("Tahoma", Font.PLAIN, 13));
        		...
        		.addGroup(gl_panel_3.createSequentialGroup()
        			.addGroup(gl_panel_3.createParallelGroup(Alignment.LEADING)
        				.addGroup(Alignment.TRAILING, gl_panel_3.createSequentialGroup()
        					.addContainerGap()
        					.addComponent(txtGiamGia, GroupLayout.DEFAULT_SIZE, 291, Short.MAX_VALUE))
        				.addGroup(Alignment.TRAILING, gl_panel_3.createSequentialGroup()
        					.addGap(10)
        					.addGroup(gl_panel_3.createParallelGroup(Alignment.TRAILING)
        						.addComponent(txtMaSP, GroupLayout.DEFAULT_SIZE, 291, Short.MAX_VALUE)
        						.addComponent(txtTenSP, GroupLayout.DEFAULT_SIZE, 291, Short.MAX_VALUE)))
        				.addGroup(Alignment.TRAILING, gl_panel_3.createSequentialGroup()
        					.addGap(20)
        					.addComponent(spinField, GroupLayout.DEFAULT_SIZE, 281, Short.MAX_VALUE))
        				.addGroup(Alignment.TRAILING, gl_panel_3.createSequentialGroup()
        					.addContainerGap()
        					.addComponent(txtDonGia, GroupLayout.DEFAULT_SIZE, 291, Short.MAX_VALUE))
        				.addGroup(Alignment.TRAILING, gl_panel_3.createSequentialGroup()
        					.addGap(212)
        					.addComponent(btnLuuTam, GroupLayout.DEFAULT_SIZE, 89, Short.MAX_VALUE))
        				.addGroup(gl_panel_3.createSequentialGroup()
        					.addContainerGap()
        				...
        				.addGroup(gl_panel_3.createSequentialGroup()
        					.addContainerGap()
        					.addComponent(lblNewLabel_1_1_1_1_3, GroupLayout.PREFERRED_SIZE, 201, GroupLayout.PREFERRED_SIZE)))
        			.addContainerGap())
        );
        gl_panel_3.setVerticalGroup(
        	gl_panel_3.createParallelGroup(Alignment.LEADING)
        		.addGroup(gl_panel_3.createSequentialGroup()
        			...
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addComponent(txtMaSP, GroupLayout.PREFERRED_SIZE, 29, GroupLayout.PREFERRED_SIZE)
        			.addGap(11)
        			.addComponent(lblNewLabel_1_1, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE)
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addComponent(txtTenSP, GroupLayout.PREFERRED_SIZE, 29, GroupLayout.PREFERRED_SIZE)
        			.addPreferredGap(ComponentPlacement.UNRELATED)
        			...
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addComponent(txtDonGia, GroupLayout.PREFERRED_SIZE, 29, GroupLayout.PREFERRED_SIZE)
        			.addPreferredGap(ComponentPlacement.UNRELATED)
        			.addComponent(lblNewLabel_1_1_1_1_3, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE)
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addComponent(txtGiamGia, GroupLayout.PREFERRED_SIZE, 29, GroupLayout.PREFERRED_SIZE)
        			.addPreferredGap(ComponentPlacement.RELATED, 17, Short.MAX_VALUE)
        			.addComponent(btnLuuTam, GroupLayout.PREFERRED_SIZE, 29, GroupLayout.PREFERRED_SIZE))
        );
        ...
        tableThemHoaDonThanhToan = new JTable();
        scrollPane.setViewportView(tableThemHoaDonThanhToan);
        modelThemHoaDonThanhToan.addColumn("Mã sản phẩm");
        modelThemHoaDonThanhToan.addColumn("Tên sản phẩm");
        modelThemHoaDonThanhToan.addColumn("Số lượng");
        modelThemHoaDonThanhToan.addColumn("Đơn giá");
        modelThemHoaDonThanhToan.addColumn("Thành tiền");
        tableThemHoaDonThanhToan.setModel(modelThemHoaDonThanhToan);
    }
