...
/*
EXEC PROC_GETID HOADONNHAPHANG

SELECT * FROM HOADONNHAPHANG


INSERT INTO CHITIETHOADONNHAPHANG (IDHOADONNHAPHANG, IDCHITIETSANPHAM, GIANHAP, SOLUONG)
VALUES (?, 10001, 250000, 100)

UPDATE CHITIETSANPHAM SET GIAVON = ((GIAVON * SOLUONG) + (?)) / (SOLUONG + ?),
SOLUONG = SOLUONG + ? WHERE IDCHI
*/
--

/*
SELECT CTSP.* FROM CHITIETSANPHAM AS CTSP JOIN SANPHAM AS SP
