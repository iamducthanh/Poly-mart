...
public class ChamCongJInternalFrame extends JInternalFrame {
                ...
                while (true) {
                    ...
                    try {
                        if (calendar.get(Calendar.AM_PM) == Calendar.AM) {
                            i = sdf.parse(sdf.format(now)).compareTo(sdf.parse("7:30:00 "
                                    + new SimpleDateFormat("aa").format(calendar.getTime())));
                            j = sdf.parse(sdf.format(now)).compareTo(sdf.parse("11:00:00 "
                                    + new SimpleDateFormat("aa").format(calendar.getTime())));
                        }
                ...
                while (true) {
                    ...
                    try {
                        if (calendar.get(Calendar.AM_PM) == Calendar.PM) {
                            i = sdf.parse(sdf.format(now)).compareTo(sdf.parse("2:30:00 "
                                    + new SimpleDateFormat("aa").format(calendar.getTime())));
                            j = sdf.parse(sdf.format(now)).compareTo(sdf.parse("22:30:00 "
                                    + new SimpleDateFormat("aa").format(calendar.getTime())));
                        }
                    } catch (ParseException e) {
                        e.printStackTrace();
    ...
    private void loadTableChamCong() {
        ...
        for (ChamCongModel chamCongModel : listChamCong) {
            ...
            try {
                if (calendar.get(Calendar.AM_PM) == Calendar.AM) {
                    i = sdf.parse(gioChamCong).compareTo(sdf.parse("8:00:00 "
                            + new SimpleDateFormat("aa").format(calendar.getTime())));
                }
            } catch (ParseException e) {
                e.printStackTrace();
            ...
            if (chamCongModel.getGioRa() != null) {
                ...
                try {
                    if (calendar.get(Calendar.AM_PM) == Calendar.PM) {
                        j = sdf.parse(gioRa).compareTo(sdf.parse("10:00:00 "
                                + new SimpleDateFormat("aa").format(calendar.getTime())));
                    }
                } catch (ParseException e) {
                    e.printStackTrace();
