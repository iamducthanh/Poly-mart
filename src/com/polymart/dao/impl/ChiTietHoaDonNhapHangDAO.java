    ...
    public boolean save(ChiTietHoaDonNhapHangModel chiTietHoaDonNhapHangModel) {
        if (chiTietHoaDonNhapHangModel != null) {
            String sqlInsert = "INSERT INTO CHITIETHOADONNHAPHANG (IDHOADONNHAPHANG, IDCHITIETSANPHAM, GIANHAP, SOLUONG)\n"
                    + "VALUES (?, ?, ?, ?)";
            return (insert(sqlInsert, chiTietHoaDonNhapHangModel.getIdHoaDonNhapHang(), chiTietHoaDonNhapHangModel.getIdChiTietSanPham(),
                    chiTietHoaDonNhapHangModel.getGiaNhap(), chiTietHoaDonNhapHangModel.getSoLuong())) > -1;
        }
        return false;
    }
