...
public class HangHoaJInternalFrame extends JInternalFrame {
	...
	private JFrame optionDanhMucFrame = new JFrame();
	...
	public void initCenterHangHoa() {
		...
		pnlLoaiHang.setBorder(new TitledBorder(null, "Lo\u1EA1i H\u00E0ng", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		pnlBanTrucTiep.setBorder(new TitledBorder(null, "B\u00E1n tr\u1EF1c ti\u1EBFp", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		pnlNgayDuKienHetHang.setBorder(new TitledBorder(null, "Ng\u00E0y d\u1EF1 ki\u1EBFn h\u1EBFt h\u00E0ng", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		pnlLienKetBanHang.setBorder(new TitledBorder(null, "Li\u00EAn k\u1EBFt b\u00E1n h\u00E0ng", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		pnlLuaChonHienThi.setBorder(new TitledBorder(null, "L\u1EF1a ch\u1ECDn hi\u1EC3n th\u1ECB", TitledBorder.LEADING, TitledBorder.TOP, null, null));
